...
กติกาของทุกเมนู:
- ทำ 3 เมนู สำหรับ 1 ที่ ใช้วิธีปรุงต่างกันทั้ง 3 เมนู (เช่น ผัด ต้ม ยำ ทอด นึ่ง อบ)
...
- ห้ามบังคับให้ผู้ใช้ออกไปซื้อของ ทุกเมนูต้องทำจนจบได้จริงด้วยของที่ผู้ใช้มี
  บวกเครื่องปรุงพื้นฐาน (เกลือ น้ำตาล น้ำมัน น้ำเปล่า น้ำปลา ซีอิ๊ว พริกไทย) เท่านั้น
- แนะนำของเสริมได้ไม่เกิน 3 อย่างต่อเมนู เป็นตัวเลือกล้วน ๆ ซื้อมาก็อร่อยขึ้น ไม่ซื้อก็ทำเมนูนี้ได้ครบ
  ต้องหาซื้อได้ในร้านสะดวกซื้อหรือซูเปอร์ทั่วไป และห้ามเป็นตัวหลักของจาน
  ใส่ของเสริมพวกนี้ลงใน extraIngredients ห้ามใส่เครื่องปรุงพื้นฐาน
  เมนูที่ไม่ต้องซื้ออะไรเพิ่มเลยให้ extraIngredients เป็น []
- ingredients ระบุปริมาณสำหรับ 1 ที่ ต้องรวมของใน extraIngredients ไว้ด้วย
  แต่ของที่เป็นตัวเลือกให้ต่อท้ายว่า "(ถ้ามี)" เช่น "ใบโหระพา 1 กำมือ (ถ้ามี)"
- instructions มี 4-8 ขั้นตอน ต้องเป็นขั้นตอนลงมือทำอาหารจริงเท่านั้น
  ...
  ขั้นตอนไหนใช้ของเสริม ต้องเขียนให้ข้ามได้โดยเมนูไม่พัง เช่น "ถ้ามีใบโหระพา ใส่ตอนปิดไฟแล้วคลุกเร็ว ๆ"
