...
// ไอคอนเส้นสไตล์ Lucide — inline ทั้งหมดเพื่อคุมน้ำหนักเส้น/สี/ขนาดด้วย currentColor
// ใช้แทน emoji ในปุ่มและ nav (emoji ยังใช้ได้ในส่วนตกแต่ง เช่น empty state)
